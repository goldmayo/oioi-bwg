...
export const analytics = {
  ...
  trackAlbumClick: debounce((albumName: string, imageSlug: string) => {
  ...
  trackSongClick: debounce((songTitle: string, albumName: string) => {
  ...
  trackLyricClick: debounce((songTitle: string, lyricText: string, startTime: number) => {
