...
|---|---|---|---|
| 0.1.1 | 2026-09-05 | - | 접근 범위, 관리자 진입 권한, 화면 유형 및 Change Log 위치 보정 |
...
|---|---|---|---|---|---|---|---|
| SCR-PUB-001 | 홈 | - | - | Page | Public | 공개 앨범 및 수록곡 진입 화면 | 확인됨 |
| SCR-PUB-002 | 응원법 | - | - | Page | Public | 전체 곡 응원법 목록과 검색/필터 | 확인됨 |
| SCR-PUB-003 | 앨범 | 앨범 상세 | - | Page | Public | 앨범 정보와 수록곡 목록 | 확인됨 |
| SCR-PUB-004 | 곡 | 응원법 뷰어 | - | Page | Public | YouTube 영상과 동기화된 가사·응원법 | 확인됨 |
| SCR-PUB-005 | 더보기 | - | - | Page | Public | 공지·오류 제보·업데이트·정책 메뉴 | 확인됨 |
| SCR-PUB-006 | 더보기 | 공지사항 | - | Page | Public | 공지 목록 및 접이식 상세 내용 | 확인됨 |
| SCR-PUB-007 | 더보기 | 안내 및 약관 | - | Page | Public | 정책 문서 목록 | 확인됨 |
| SCR-PUB-008 | 더보기 | 안내 및 약관 | 정책 상세 | Page | Public | privacy/terms/copyright/email/ga 문서 | 확인됨 |
| SCR-PUB-009 | 더보기 | 오류 제보 | - | Page | Public | 외부 Google Form 오류 제보 안내 | 확인됨 |
| SCR-PUB-010 | 더보기 | 업데이트 내역 | - | Page | Public | 업데이트 내역 정적 목록 | 확인됨 |
| SCR-AUTH-001 | 관리자 | 로그인 | - | Page | Guest Only | 관리자 계정 이메일·비밀번호 로그인 | 확인됨 |
| SCR-ADM-001 | 관리자 | 관리 홈 | - | Redirect | Admin | `/admin/albums`로 이동하는 진입 경로 | 확인됨 |
