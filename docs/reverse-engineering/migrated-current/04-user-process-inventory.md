...
| Process ID | 프로세스 | 선조건 | 정상 흐름 | 주요 예외 후보 | 후조건 | 상태 |
|---|---|---|---|---|---|---|
...
| PROC-PUB-007 | 정책 확인 | 정책 목록 또는 정책 상세 URL 접근 | 정책 목록 진입 → 정책 선택 → 정책 본문 확인 | 정의되지 않은 slug 입력 시 `privacy` 상세로 fallback | 정책 내용 표시 | 확인됨 |
